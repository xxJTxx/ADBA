...
class LocalUpdate_with_mask(object):
    ...
    def update_weights(self, model, save_dir):
        ...
        torch.save(pattern_nc, os.path.join(save_dir, "pattern.pt"))
        torch.save(mask_nc, os.path.join(save_dir, "mask.pt"))
...
if __name__ == '__main__':
    ...
    if args.type == "pretrain":
        ...
        exp_name = "_".join([args.dataset, args.model, str(args.local_ep), str(args.alpha_backdoor), str(args.beta_backdoor), str(args.target_label_backdoor), args.msg])
        output_dir = os.path.join('saved', exp_name)
        ...
        w_poison, local_acc_poison = local_model.update_weights(copy.deepcopy(global_model), extra_dir)
        ...
        torch.save(local_weights, os.path.join(extra_dir, "checkpoint.pkl"))
        # ===============================================
